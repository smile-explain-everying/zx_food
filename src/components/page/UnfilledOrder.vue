<template>
    <div class="index-warp">
        ...
        <el-dialog title="新增订单" :visible.sync="newOrderSwitch" width="30%">
            <el-form :model="formNewOrder"  :rules="rules"  ref="formNewOrder" >
                ...
                <el-form-item prop="phone" label="手机号" :label-width="formLabelWidth">
                  <el-input v-model="formNewOrder.phone" auto-complete="off" :maxlength="11"></el-input>
                </el-form-item>
                ...
                <el-form-item  prop="pname" label="产品名称" :label-width="formLabelWidth">
                    <el-select v-model="formNewOrder.pname" clearable placeholder="请选择产品" class="" @change="changeGoodName" style="width:350px;">
                        <el-option
                ...
                <el-form-item prop="data" label="交付日期" :label-width="formLabelWidth">
                    <el-date-picker
                          ...
                          style="width:350px"
                          :default-value="pickerOptions1"
                        >
                    </el-date-picker>
                </el-form-item>
                <el-form-item  prop="state" label="状态" :label-width="formLabelWidth">
                    <el-select v-model="formNewOrder.state" clearable placeholder="请选择状态" class="" style="width:350px;">
                        <el-option
        ...
        <el-table :data="indexData" border style="width: 100%" ref="indexTable">
            ...
            <el-table-column prop="goodsPrice" label="总价（元）">
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleEdit(
      ...
      (this.editOrderSwitch = true), (this.formEditOrder.id = id);
