<template>
	<div class="index-warp">
        ...
        <el-dialog title="成品制作" :visible.sync="finishedProductSwitch" width="46%">
            <el-form  :model="formFinishedProduct"  ref="formFinishedProduct" class="demo-form-inline">
              ...
              <div class="ul-r" style="display:block">
                    <el-form-item  v-for="(v, index) in formFinishedProduct.material">
                        <el-button type="danger" @click="delMaterial(v)" style="margin-right:85px;">删除原料</el-button>
                    </el-form-item>
               </div>
                </div>
           ...
           <el-button type="primary" @click="addMaterial" style="float:right;margin:0 85px 20px 0;">添加原料</el-button>
            <div slot="footer" class="dialog-footer" style="margin-top:30px;padding-right:85px;">
		...
		<el-table :data="inventoryData" border style="width: 100%" ref="indexTable" class="InventoryTable">
            ...
            <el-table-column prop="materialPrice" label="单价(元)" width="150">
            </el-table-column>
